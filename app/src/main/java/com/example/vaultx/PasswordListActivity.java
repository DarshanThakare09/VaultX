...
public class PasswordListActivity extends AppCompatActivity {
    ...
    private void loadPasswords() {
            ...
            if (files != null) {
                for (File file : files) {
                    ...
                    try {
                        ...
                        if (parts.length >= 3) {
                            String website = parts.length > 3 ? parts[3] : "";
                            passwordList.add(new Password(parts[0], parts[1], parts[2], website, file.getName()));
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
        ...
        tvEmpty.setVisibility(passwordList.isEmpty() ? View.VISIBLE : View.GONE);
        recyclerPasswords.setVisibility(passwordList.isEmpty() ? View.GONE : View.VISIBLE);
    }
}
